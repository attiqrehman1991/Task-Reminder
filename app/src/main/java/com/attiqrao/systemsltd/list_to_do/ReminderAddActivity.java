...
public class ReminderAddActivity extends AppCompatActivity implements
    ...
    private EditText mTitleText, mTitleDesc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitleDesc = (EditText) findViewById(R.id.reminder_desc);
    ...
    public void saveReminder(){
        ...
        // Creating Reminder
        int ID = rb.addReminder(new Reminder(mTitle, mDesc, mDate, mTime, mRepeat, mRepeatNo, mRepeatType, mActive));
